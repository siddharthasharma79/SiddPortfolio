...
const updateDrawerState = opened => {
  return {
...
const app$1 = (state = INITIAL_STATE, action) => {
  switch (action.type) {
    case UPDATE_PAGE:
      return { ...state,
        page: action.page
